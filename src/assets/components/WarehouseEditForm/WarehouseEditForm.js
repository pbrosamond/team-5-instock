...
const EditWarehouseForm = () => {
    ...
    return (
        <>
        <h1 className="main">Test for header</h1>
        ...
        <h1 className="main">Test for footer</h1>
