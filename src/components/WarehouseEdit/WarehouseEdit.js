            ...
            <section className="form__section">
              ...
              <div className="form__questions">
                ...
                <input
                  ...
                  className="form__input"
                  placeholder="Canada"
                  value={`${currentWarehouse.country}`}
                  onChange={handleChange}
                ></input>
              </div>
            </section>
            <section className="form__section divider">
              ...
              <div className="form__questions">
                ...
                <input
                  ...
                  value={`${currentWarehouse.contact_name}`}
                  onChange={handleChange}
                ></input>
              </div>
              <div className="form__questions">
                <label htmlFor="contact_position" className="form__label">
                  Position
                </label>
                <input
                  type="text"
                  ...
                  value={`${currentWarehouse.contact_position}`}
                  onChange={handleChange}
                ></input>
              </div>
              <div className="form__questions">
                <label htmlFor="contact_phone" className="form__label">
                  Phone Number
                </label>
                <input
                  type="tel"
                  ...
                  value={`${currentWarehouse.contact_phone}`}
                  onChange={handleChange}
                ></input>
              </div>
              <div className="form__questions">
